    ...
    public class DbInitializer
    {
        public static void Initialize(VRBikeContext context) {
            ...
            var tours = new Tour[]
            {
                ...
                new Tour{Difficulty="1: very easy", TumbUrl="vigne.webp", Color="blue", Distanza=13,Salita=130,Discesa=150, MapCenter="[45.46, 10.76]",MapZoom=11, GeoJsonFile="bussolengo-lago.json", TourCollectionID=1, PageTitle="terre del custoza By bike tra vigne e parchi" , Raccolta="custoza, local, collina, gabanel", Percorso="Bussolengo, Pacengo, Garda", Description="Giro in e-bike facile. Adatto a ogni livello di allenamento. Superfici perlopiù asfaltate. Adatto a ogni livello di abilità."},
                new Tour{Difficulty="2: easy",TumbUrl="c16.webp",Color="blue",Distanza=32,Salita=160,Discesa=130, MapCenter="[45.46, 10.76]",MapZoom=11, GeoJsonFile="16.json",TourCollectionID=1,PageTitle="terre del custoza tour 16" , Raccolta="custoza, local, valpolicella, adige, collina", Percorso="Villafranca, Sommacampagna, Bussolengo, Pescantina, Cavaion", Description="ciclovia tra Terre del Custoza e Valpolicella,Giro in bici facile. Adatto a ogni livello di allenamento. Superfici perlopiù asfaltate. Adatto a ogni livello di abilità."},
                new Tour{Difficulty="3: medium",TumbUrl="ev7.webp",Color="red", Distanza=133,Salita=590,Discesa=740, MapCenter="[45.46, 10.76]",MapZoom=10,GeoJsonFile="ev7.json",TourCollectionID=1,PageTitle="Eurovelo 7" , Raccolta="national, montagna, collina", Percorso="Rovereto, Garda, Lazise, Peschiera, Valeggio sul Mincio, Mantova", Description="Giro in e-bike per esperti. Ottimo allenamento richiesto. In alcune parti del Tour potresti dover spingere la bici."},
                new Tour{Difficulty="2: easy",TumbUrl="c29.webp",Color="blue",Distanza=18,Salita=70,Discesa=170,MapCenter="[45.46, 10.76]",MapZoom=11,GeoJsonFile="29.json",TourCollectionID=1,PageTitle="terre del custoza tour 29" , Raccolta="custoza, local, collina, gabanel", Percorso="Bussolengo, Castelnuovo", Description="Giro in e-bike facile. Adatto a ogni livello di allenamento. Superfici perlopiù asfaltate. Adatto a ogni livello di abilità."},
                new Tour{Difficulty="2: easy",TumbUrl = "c30.webp", Color="blue",Distanza=22,Salita=140,Discesa=170,MapCenter="[45.46, 10.76]",MapZoom=11,GeoJsonFile="30.json",TourCollectionID=1,PageTitle="terre del custoza tour 30" , Raccolta="custoza, local, collina", Percorso="Bussolengo, Palazzolo,san Giorgio in Salici, Custoza, Valeggio sul Mincio", Description="Giro in e-bike facile. Adatto a ogni livello di allenamento. Superfici perlopiù asfaltate. Adatto a ogni livello di abilità."},
                new Tour{Difficulty="2: easy",TumbUrl="c35.webp", Color="blue",Distanza=11,Salita=110,Discesa=220,MapCenter="[45.46, 10.76]",MapZoom=11,GeoJsonFile="35.json",TourCollectionID=1,PageTitle="terre del custoza tour 35" , Raccolta="custoza, local, collina, gabanel", Percorso="Bussolengo, Palazzolo, Sona, Sommacampagna", Description="Giro in e-bike facile. Adatto a ogni livello di allenamento. Superfici perlopiù asfaltate. Adatto a ogni livello di abilità."},
                new Tour{Difficulty="3: medium",TumbUrl="adigesud.webp",Color="purple",Distanza=54,Salita=70,Discesa=100,MapCenter="[45.42, 10.98]",MapZoom=10,GeoJsonFile="adigesud.json",TourCollectionID=1 ,PageTitle="Parco adige sud" , Raccolta="local, regional, adige", Percorso="Verona, Zevio, Legnago", Description="Giro in E-MTB intermedio. Buon allenamento richiesto. Superfici perlopiù asfaltate. Adatto a ogni livello di abilità."},
                new Tour{Difficulty="3: medium",TumbUrl = "cca.webp", Color="purple",Distanza=56,Salita=80,Discesa=130,MapCenter="[45.42, 10.98]",MapZoom=10,GeoJsonFile="cca.json",TourCollectionID=1 ,PageTitle="claudia augusta" , Raccolta="local, regional", Percorso="Verona, Castel d'Azzano,Isola della Scala, Ostiglia", Description="Giro in E-MTB intermedio. Buon allenamento richiesto. Alcune parti del percorso potrebbero essere non asfaltate o difficili da percorrere in bici."},
                new Tour{Difficulty="3: medium",TumbUrl="cdr.webp",Color="blue",Distanza=32,Salita=10,Discesa=60, MapCenter="[45.42, 10.98]",MapZoom=10,GeoJsonFile="cdr.json",TourCollectionID=1 ,PageTitle="ciclovia delle risorgive" , Raccolta="local", Percorso="Zevio, Castel d'Azzano, Villafranca, Valeggio sul Mincio", Description="Giro in e-bike facile. Adatto a ogni livello di allenamento. Superfici perlopiù asfaltate. Adatto a ogni livello di abilità."},
                new Tour{Difficulty="3: medium",TumbUrl = "vrma.webp", Color="purple",Distanza=44,Salita=50,Discesa=100,MapCenter="[45.42, 10.76]",MapZoom=10,GeoJsonFile="vrma.json",TourCollectionID=1 ,PageTitle="Verona Mantova" , Raccolta="regional, local", Percorso="Verona, Dossobuono, Povegliano, Villafranca, Mantova", Description="Giro in bici intermedio. Buon allenamento richiesto. Superfici perlopiù asfaltate. Adatto a ogni livello di abilità."},
                new Tour{Difficulty="4: challenging",TumbUrl="i1.webp",Color="red",Distanza=112,Salita=830,Discesa=860,MapCenter="[45.42, 10.98]",MapZoom=10,GeoJsonFile="i1.json",TourCollectionID=1 ,PageTitle="itinerario 1" , Raccolta="regional, adige, collina", Percorso="Garda, Rivoli, Bussolengo, Verona, Soave, Vicenza", Description="Giro in e-bike per esperti. Buon allenamento richiesto. In alcune parti del Tour potresti dover spingere la bici."},
            ...
            var tourMarkers = new TourMarker[]
            {
                ...
                new TourMarker{TourID=1, Classname="bl-div-icon", Html="Vigne e parchi", IconSize="[85, 17]", Position="[45.474, 10.77]"},        
