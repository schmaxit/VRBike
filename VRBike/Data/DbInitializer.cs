    ...
    public class DbInitializer
    {
        public static void Initialize(VRBikeContext context) {
            ...
            var tours = new Tour[]
            {
                ...
                new Tour{Difficulty="1: very easy", TumbUrl="vigne.webp", Color="blue", Distanza=13,Salita=130,Discesa=150, MapCenter="[45.46, 10.76]",MapZoom=11, GeoJsonFile="bussolengo-lago.json", TourCollectionID=1, PageTitle="terre del custoza By bike tra vigne e parchi" , Raccolta="custoza, local", Percorso="Bussolengo Pacengo Garda", Description="Terre del Custoza"},
                new Tour{Difficulty="2: easy",TumbUrl="c16.webp",Color="blue",Distanza=32,Salita=160,Discesa=130, MapCenter="[45.46, 10.76]",MapZoom=11, GeoJsonFile="16.json",TourCollectionID=1,PageTitle="terre del custoza tour 16" , Raccolta="custoza, local, valpolicella, adige", Percorso="Villafranca Sommacampagna Pescantina Cavaion", Description="ciclovia tra Terre del Custoza e Valpolicella"},
                new Tour{Difficulty="3: medium",TumbUrl="ev7.webp",Color="red", Distanza=133,Salita=590,Discesa=740, MapCenter="[45.46, 10.76]",MapZoom=10,GeoJsonFile="ev7.json",TourCollectionID=1,PageTitle="Eurovelo 7" , Raccolta="national", Percorso="Rovereto, Garda, Lazise, Peschiera, Valeggio sul Mincio, Mantova", Description=""},
                new Tour{Difficulty="2: easy",TumbUrl="c29.webp",Color="blue",Distanza=18,Salita=70,Discesa=170,MapCenter="[45.46, 10.76]",MapZoom=11,GeoJsonFile="29.json",TourCollectionID=1,PageTitle="terre del custoza tour 29" , Raccolta="custoza, local", Percorso="Bussolengo Castelnuovo", Description=""},
                new Tour{Difficulty="2: easy",TumbUrl = "c30.webp", Color="blue",Distanza=22,Salita=140,Discesa=170,MapCenter="[45.46, 10.76]",MapZoom=11,GeoJsonFile="30.json",TourCollectionID=1,PageTitle="terre del custoza tour 30" , Raccolta="custoza, local", Percorso="Bussolengo Castelnuovo", Description=""},
                new Tour{Difficulty="2: easy",TumbUrl="c35.webp", Color="blue",Distanza=11,Salita=110,Discesa=220,MapCenter="[45.46, 10.76]",MapZoom=11,GeoJsonFile="35.json",TourCollectionID=1,PageTitle="terre del custoza tour 35" , Raccolta="custoza, local", Percorso="Bussolengo Sommacampagna", Description=""},
                ...
                new Tour{Difficulty="4: challenging",TumbUrl="i1.webp",Color="red",Distanza=112,Salita=830,Discesa=860,MapCenter="[45.42, 10.98]",MapZoom=10,GeoJsonFile="i1.json",TourCollectionID=1 ,PageTitle="itinerario 1" , Raccolta="regional, national, adige", Percorso="Garda, Rivoli, Bussolengo, Verona, Soave, Vicenza", Description=""},
                ...
                new Tour{Difficulty="5: very challenging",TumbUrl="valpo12.webp",Color="blue",Distanza=32,Salita=1120,Discesa=260, MapCenter="[45.55, 10.95]",MapZoom=10,GeoJsonFile="valpo12.json",TourCollectionID=1 ,PageTitle="valpolicella tour 12" , Raccolta="valpolicella, local", Percorso="Verona Fosse", Description=""},
                new Tour{Difficulty="4: challenging",TumbUrl = "ev7.webp", Color="blue",Distanza=33,Salita=524,Discesa=150, MapCenter="[45.55, 10.9]",MapZoom=10,GeoJsonFile="valpo46.json",TourCollectionID=1 ,PageTitle="valpolicella tour 46" , Raccolta="valpolicella, local, adige", Percorso="Verona, Domegliara, Dolcè, Peri", Description=""},
                new Tour{Difficulty="5: very challenging",TumbUrl = "aida.webp", Color="red",Distanza=178,Salita=800,Discesa=930, MapCenter="[45.55, 10.9]",MapZoom=10,GeoJsonFile="aida.json",TourCollectionID=1 ,PageTitle="ciclovia Aida" , Raccolta="national", Percorso="Brescia,Peschiera del Garda, Sommacampagna, Verona,Soave, Vicenza", Description=""}
