    ...
    public class DbInitializer
    {
        public static void Initialize(VRBikeContext context) {
            ...
            var tours = new Tour[]
            {
                ...
                new Tour{Difficulty="3: medium",TumbUrl = "vrma.webp", Color="purple",Distanza=44,Salita=50,Discesa=100,MapCenter="[45.313347, 10.858430]",MapZoom=10,GeoJsonFile="vrma.json",TourCollectionID=1 ,PageTitle="Verona Mantova" , Raccolta="regional, local", Percorso="Verona, Dossobuono, Povegliano, Villafranca, Mantova", Description="Giro in bici intermedio. Buon allenamento richiesto. Superfici perlopiù asfaltate. Adatto a ogni livello di abilità."},
